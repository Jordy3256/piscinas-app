...
from .views import (
    ...
    contratos_datos_facturacion_pdf_view,
    contrato_list_view,
    contrato_crear_view,
    contrato_editar_view,
    contrato_reactivar_view,
    contrato_renovar_view,
    contrato_promocion_nueva_view,
    contrato_detalle_view,
    contrato_responsable_reposicion_view,
    ...
    trabajadores_list_view,
    trabajador_detalle_view,
    trabajador_expediente_pdf_view,
...
urlpatterns = [
    ...
    path(
        "inteligencia/crecimiento/",
        inteligencia_crecimiento_view,
        name="inteligencia_crecimiento",
    ),
    path(
    ...
    path("inteligencia/", centro_inteligencias_view, name="centro_inteligencias"),
    ...
    path("contratos/datos-facturacion.pdf", contratos_datos_facturacion_pdf_view, name="contratos_datos_facturacion_pdf"),
    ...
    path(
        "contratos/<int:pk>/responsable-reposicion/",
        contrato_responsable_reposicion_view,
        name="contrato_responsable_reposicion",
    ),
    ...
    path("contratos/<int:pk>/promocion/nueva/", contrato_promocion_nueva_view, name="contrato_promocion_nueva"),
    path(
        "contratos/<int:pk>/reactivar/",
        contrato_reactivar_view,
        name="contrato_reactivar",
    ),
    path(
    ...
    path(
        "mantenimientos/<int:pk>/cancelar/",
        mantenimiento_cancelar_view,
    ...
    path(
        "fotos/<int:pk>/archivo/",
        foto_mantenimiento_archivo_view,
        name="foto_mantenimiento_archivo",
    ),
    path(
    ...
    path("trabajadores/", trabajadores_list_view, name="trabajadores_list"),
    path("trabajadores/<int:pk>/", trabajador_detalle_view, name="trabajador_detalle"),
    path("trabajadores/<int:pk>/expediente.pdf", trabajador_expediente_pdf_view, name="trabajador_expediente_pdf"),
