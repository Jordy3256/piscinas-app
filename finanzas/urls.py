...
urlpatterns = [
    path("archivos/<str:tipo>/<int:pk>/", views.archivo_financiero_view, name="finanzas_archivo"),
    ...
    path("contratos-activos.pdf", views.contratos_financieros_pdf, name="finanzas_contratos_pdf"),
    ...
    path("facturacion/", views.facturacion_pendiente_lista, name="finanzas_facturacion_pendiente"),
    path("facturacion/<int:pk>/realizada/", views.facturacion_marcar_realizada, name="finanzas_facturacion_realizada"),
    ...
    path("facturas/<int:pk>/anular/", views.factura_anular_manual, name="finanzas_factura_anular"),
    path("facturas/<int:pk>/reactivar/", views.factura_reactivar_manual, name="finanzas_factura_reactivar"),
