...
urlpatterns = [
    ...
    path("digital/piscina/<int:pk>/", views.digital_piscina_detalle_view, name="digital_piscina_detalle"),
    path("digital/soporte/", views.digital_soporte_view, name="digital_soporte"),
    path("digital/soporte-burbuja/", views.digital_soporte_burbuja_api, name="digital_soporte_burbuja_api"),
    path("digital/soporte/<int:pk>/mensajes/", views.digital_soporte_mensajes_api, name="digital_soporte_mensajes_api"),
    path("digital/soporte/<int:pk>/", views.digital_soporte_chat_view, name="digital_soporte_chat"),
    path("digital/sugerencias/", views.digital_soporte_view, name="digital_sugerencias"),
    ...
    path("administracion/soporte/", views.soporte_admin_lista_view, name="soporte_admin_lista"),
    path("administracion/soporte-burbuja/", views.soporte_admin_burbuja_api, name="soporte_admin_burbuja_api"),
    path("administracion/soporte/<int:pk>/mensajes/", views.soporte_admin_mensajes_api, name="soporte_admin_mensajes_api"),
    path("administracion/soporte/<int:pk>/", views.soporte_admin_chat_view, name="soporte_admin_chat"),
    ...
    path("administracion/academia-cms/contenido/<int:contenido_pk>/material/", views.academia_cms_material_form_view, name="cms_material_nuevo"),
    path("administracion/academia-cms/material/<int:pk>/eliminar/", views.academia_cms_material_eliminar_view, name="cms_material_eliminar"),
